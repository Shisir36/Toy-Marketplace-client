...
import backgroundImage from "../../../assets/OfferTime/rod-long-I8hgs3ygtII-unsplash.jpg";
...
const AboutUs = () => {
  return (
    <section
      ...
      style={{
        backgroundImage: 'linear-gradient(to bottom, rgba(0,0,0,0.2), rgba(0,0,0,0.2)), url("https://images.unsplash.com/photo-1621719456027-93da798ec181?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1228&q=80")',
    ...
    >
      <div
        className="bg-black bg-opacity-50 h-full md:p-28 py-5"
        data-aos="zoom-in"
      >
        <div className="container mx-auto md:px-4">
          <div className="text-white w-full">
            ...
            <div className="mt-8 text-center md:text-left">
              <a
                href="#shop"
                className="bg-[#4acdd5] hover:bg-[#FF6799] text-white font-bold md:py-3 md:px-6 px-3 py-2 rounded-md shadow-lg transition duration-300 inline-block"
              >
